  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className="absolute top-5 right-5 px-4 py-1 rounded-full bg-black/60 text-white text-xs tracking-widest border border-white/20 opacity-0 group-hover:opacity-100 transition-all duration-300"
          aria-hidden="true"
        >
          VEZI PROIECTUL
        </div>
